...
(function () {
  ...
  function sheetHTML(d, wp) {
    ...
    var total = num(d.TotalAmount), paid = num(d.PaidAmount), bal = num(d.Balance); var BLUE = '#1f78b4';
    return '<div id="fpSheet" style="background:#fff;color:#1f2733;max-width:794px;margin:0 auto;padding:34px 40px;font-family:Asap,Arial,sans-serif;font-size:12.5px">'
